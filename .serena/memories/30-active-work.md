...
_Auto-updated at 2026-06-03 20:01 (422 files)_

- backend/.gitignore
- backend/migrations/0000_initial_database_schema.sql
- backend/schema.sql
- backend/src/db/admin-auth-queries.js
- backend/src/db/admin-queries.js
- backend/src/db/admin-queries.ts
- backend/src/db/admin-teaching-queries.js
- backend/src/db/attendance-queries.js
- backend/src/db/attendance-queries.ts
- backend/src/db/certificate-queries.js
- backend/src/db/certificate-shipment-queries.js
- backend/src/db/class-queries.js
- backend/src/db/class-schedule-queries.js
- backend/src/db/class-session-queries.js
- backend/src/db/class-teacher-queries.js
- backend/src/db/document-queries.js
- backend/src/db/enrollment-queries.js
- backend/src/db/exam-queries.js
- backend/src/db/homepage-queries.js
- backend/src/db/messaging-queries.js
- backend/src/db/notification-queries.js
- backend/src/db/payment-queries.js
- backend/src/db/post-queries.js
- backend/src/db/queries.js
- backend/src/db/student-queries.js
- backend/src/db/student-queries.ts
- backend/src/index.js
- backend/src/index.ts
- backend/src/lib/api-templates.js
- backend/src/lib/api-templates/delete-endpoint.js
- backend/src/lib/api-templates/get-endpoint.js
- backend/src/lib/api-templates/post-endpoint.js
- backend/src/lib/api-templates/put-endpoint.js
- backend/src/lib/api-templates/types.js
- backend/src/lib/auth/session-broker.js
- backend/src/lib/program-platform/http.js
- backend/src/lib/program-platform/repository.js
- backend/src/lib/program-platform/repository.ts
- backend/src/lib/repositories/exam-access-repository.js
- backend/src/lib/repositories/exam-activity-repository.js
- backend/src/lib/repositories/exam-answer-repository.js
- backend/src/lib/repositories/exam-answer-scorer.js
- backend/src/lib/repositories/exam-attempt-repository.js
- backend/src/lib/repositories/exam-import-repository.js
- backend/src/lib/repositories/exam-question-repository.js
- backend/src/lib/repositories/exam-registration-repository.js
- backend/src/lib/repositories/exam-review-repository.js
- backend/src/lib/repositories/exam-section-repository.js
- backend/src/lib/repositories/exam-test-detail-repository.js
- backend/src/lib/repositories/exam-test-repository.js
- backend/src/lib/repositories/exam-type-repository.js
- backend/src/lib/repositories/online-classes.js
- backend/src/lib/services/classes.js
- backend/src/lib/services/exam-schedule-class-sync.js
- backend/src/lib/services/online-classes.js
- backend/src/lib/services/online-classes.ts
- backend/src/middleware/auth-middleware.js
- backend/src/middleware/error-handler.js
- backend/src/repositories/document-repository.js
- backend/src/repositories/exam-repository.js
...
- backend/src/routes/admin-teaching.js
...
- backend/src/routes/class-schedules.js
- backend/src/routes/class-teachers.js
- backend/src/routes/classes.js
- backend/src/routes/classes.ts
- backend/src/routes/document-folders.js
- backend/src/routes/documents.js
- backend/src/routes/documents.ts
- backend/src/routes/errors.js
- backend/src/routes/exam-categories.js
- backend/src/routes/exam-schedules.js
- backend/src/routes/exam-schedules.ts
- backend/src/routes/exam-types.js
- backend/src/routes/export.js
- backend/src/routes/export.ts
- backend/src/routes/field-definitions.js
- backend/src/routes/field-options.js
- backend/src/routes/homepage.js
- backend/src/routes/messaging.js
- backend/src/routes/messaging.ts
- backend/src/routes/notifications.js
- backend/src/routes/online-classes.js
- backend/src/routes/online-classes.ts
- backend/src/routes/payments.js
- backend/src/routes/posts.js
- backend/src/routes/program-levels.js
- backend/src/routes/program-organizers.js
- backend/src/routes/programs.js
- backend/src/routes/public-student-feedbacks.js
- backend/src/routes/registrations.js
- backend/src/routes/reports.js
- backend/src/routes/seed-exam-tests.js
- backend/src/routes/shipping.js
- backend/src/routes/sso.js
- backend/src/routes/sso.ts
- backend/src/routes/student-feedbacks.js
- backend/src/routes/student-reviews.js
- backend/src/routes/student-reviews.ts
...
- backend/src/services/ai-persona.js
- backend/src/services/ai-service.js
- backend/src/services/cccd-ocr-parser.js
- backend/src/services/cccd-ocr-parser.ts
- backend/src/services/cccd-ocr-service.js
- backend/src/services/cccd-ocr-service.ts
- backend/src/services/document-service.js
- backend/src/services/google-auth.js
- backend/src/services/google-auth.ts
- backend/src/services/google-calendar.js
- backend/src/services/google-calendar.ts
- backend/src/services/google-calendar/utils.js
- backend/src/services/google-vision-ocr.js
- backend/src/services/google-vision-ocr.ts
- backend/src/services/learning-schedule-ocr.js
- backend/src/services/photo-3x4-pipeline.js
- backend/src/services/student-service.js
- backend/src/services/student-service.ts
- backend/src/services/viettel-post-address.js
- backend/src/services/viettel-post.js
- backend/src/test/repositories/online-classes-enrollments.test.js
- backend/src/test/repositories/online-classes-enrollments.test.ts
- backend/src/test/repositories/online-classes-queries.test.js
- backend/src/test/repositories/online-classes-queries.test.ts
- backend/src/test/repositories/student-repository.test.js
- backend/src/test/routes/attendance-routes.test.js
- backend/src/test/routes/cache-headers.test.js
- backend/src/test/routes/class-sessions.test.js
- backend/src/test/routes/exam-schedules.test.js
- backend/src/test/routes/export.test.js
- backend/src/test/routes/export.test.ts
- backend/src/test/routes/online-classes-auth.test.js
- backend/src/test/routes/online-classes-endpoints.test.js
- backend/src/test/routes/online-classes-test-setup.js
- backend/src/test/routes/payments.test.js
- backend/src/test/routes/program-organizers.test.js
- backend/src/test/routes/programs.test.js
- backend/src/test/routes/read-only-mode.test.js
- backend/src/test/routes/student-feedbacks.test.js
- backend/src/test/services/birth-place.test.js
- backend/src/test/services/cccd-ocr.test.js
- backend/src/test/services/learning-schedule-ocr.test.js
- backend/src/test/services/online-classes-calendar-sync.test.js
- backend/src/test/services/online-classes-capacity.test.js
- backend/src/test/services/online-classes-capacity.test.ts
- backend/src/test/services/online-classes-create.test.js
- backend/src/test/services/student-profile-update.test.js
- backend/src/test/services/student-profile.test.js
- backend/src/test/services/viettel-post-address.test.js
- backend/src/test/setup-real-db.js
- backend/src/test/setup-real-db.ts
- backend/src/test/utils/backup.test.js
- backend/src/types/env.js
- backend/src/types/env.ts
- backend/src/utils/backup.js
- backend/src/utils/birth-place.js
- backend/src/utils/cloudflare-images.js
- backend/src/utils/cloudflare-images.ts
- backend/src/utils/email-service.js
- backend/src/utils/file-utils.js
- backend/src/utils/helpers.js
- backend/src/utils/notification-helper.js
- backend/src/utils/notification-helper.ts
- backend/src/utils/pdf-generator.js
- backend/src/utils/rate-limiter.js
- backend/src/utils/response-helpers.js
- backend/src/utils/response.js
- backend/src/utils/session-manager.js
- backend/src/workers-ai/cccd-detector.js
...
- frontend/src/components/admin/CertificateShipmentModal.tsx
- frontend/src/components/admin/GlobalSearch.tsx
- frontend/src/components/admin/MobileActionSheet.tsx
- frontend/src/components/admin/MobileBottomNav.tsx
- frontend/src/components/admin/MobileDataCard.tsx
- frontend/src/components/admin/MobileForm.tsx
- frontend/src/components/admin/MobileModal.tsx
- frontend/src/components/admin/MobileSearchBar.tsx
- frontend/src/components/ai/AIAssistant.tsx
- frontend/src/components/common/SEO.tsx
- frontend/src/components/common/SocialShare.tsx
- frontend/src/components/forms/QuickConsultForm.tsx
...
- frontend/src/components/layout/ModernDashboardLayout.tsx
- frontend/src/components/layout/ModernFooter.tsx
- frontend/src/components/layout/ModernHeader.tsx
- frontend/src/components/layout/ModernPublicLayout.tsx
- frontend/src/components/layout/StudentMobileLayout.css
- frontend/src/components/layout/StudentMobileLayout.tsx
- frontend/src/components/modals/AddStudentModal.tsx
- frontend/src/components/profile/StudentProfileEditor.tsx
- frontend/src/components/sections/TestimonialsSection.tsx
- frontend/src/components/student/StudentBottomNav.tsx
...
- frontend/src/components/ui/DocumentsTab.tsx
...
- frontend/src/components/ui/PullToRefreshWrapper.tsx
- frontend/src/components/ui/ScrollToTopButton.tsx
...
- frontend/src/components/upload/ImageEditor.css
- frontend/src/components/upload/ImageEditorMobile.css
- frontend/src/components/upload/ImageEditorMobile.tsx
- frontend/src/components/upload/cccd-image-quality.ts
- frontend/src/components/upload/document-normalization.ts
- frontend/src/components/upload/overlayUtils.ts
- frontend/src/contexts/LanguageContext.tsx
- frontend/src/features/student/student-hooks.ts
- frontend/src/features/student/student-shared.tsx
- frontend/src/features/student/views/StudentExamsView.tsx
- frontend/src/hooks/queries/use-classes.ts
- frontend/src/hooks/queries/use-registrations.ts
- frontend/src/hooks/queries/use-students.ts
- frontend/src/hooks/useAnalytics.ts
- frontend/src/hooks/useAudioRecorder.tsx
- frontend/src/hooks/usePullToRefresh.ts
- frontend/src/index.css
- frontend/src/lib/api.ts
- frontend/src/lib/gsap-react.ts
- frontend/src/lib/utils.ts
- frontend/src/main.tsx
- frontend/src/pages/admin/auth/AdminLogin.tsx
- frontend/src/pages/admin/auth/PasswordResetPage.tsx
- frontend/src/pages/admin/desktop/ActivityLogs.tsx
- frontend/src/pages/admin/desktop/AdminAttendancePage.tsx
- frontend/src/pages/admin/desktop/AdminDashboardDesktop.tsx
- frontend/src/pages/admin/desktop/AdminManagement.tsx
- frontend/src/pages/admin/desktop/AdminProfile.tsx
- frontend/src/pages/admin/desktop/AssignmentsManagement.tsx
...
- frontend/src/pages/admin/desktop/DocumentsManagement.tsx
- frontend/src/pages/admin/desktop/ExamSchedulesPage.tsx
- frontend/src/pages/admin/desktop/HomepageManagement.tsx
- frontend/src/pages/admin/desktop/MyClassesPage.tsx
- frontend/src/pages/admin/desktop/MyExamsPage.tsx
- frontend/src/pages/admin/desktop/MySchedulePage.tsx
...
- frontend/src/pages/admin/desktop/RegistrationsManagement.tsx
- frontend/src/pages/admin/desktop/StudentFeedbackManagement.tsx
...
- frontend/src/pages/admin/desktop/students/StudentGridView.tsx
- frontend/src/pages/admin/desktop/students/StudentStatsBar.tsx
- frontend/src/pages/admin/desktop/students/StudentTableView.tsx
- frontend/src/pages/admin/mobile/AdminDashboardMobile.tsx
- frontend/src/pages/admin/mobile/MobileAdminProfileModule.tsx
- frontend/src/pages/admin/mobile/MobileAssignmentsModule.tsx
- frontend/src/pages/admin/mobile/MobileAttendanceModule.tsx
- frontend/src/pages/admin/mobile/MobileClassesModule.tsx
- frontend/src/pages/admin/mobile/MobileDashboardOverview.tsx
- frontend/src/pages/admin/mobile/MobileDocumentsModule.tsx
- frontend/src/pages/admin/mobile/MobileExamSchedulesModule.tsx
- frontend/src/pages/admin/mobile/MobileMyClassesModule.tsx
- frontend/src/pages/admin/mobile/MobileMyExamsModule.tsx
- frontend/src/pages/admin/mobile/MobileMyScheduleModule.tsx
- frontend/src/pages/admin/mobile/MobilePaymentsModule.tsx
- frontend/src/pages/admin/mobile/MobilePlaceholder.tsx
- frontend/src/pages/admin/mobile/MobileSimpleModules.tsx
...
- frontend/src/pages/admin/shared/hooks/useAssignmentsManagement.ts
- frontend/src/pages/admin/shared/hooks/useClassesManagement.ts
- frontend/src/pages/admin/shared/hooks/useDocumentsManagement.ts
- frontend/src/pages/admin/shared/hooks/usePaymentsManagement.ts
...
- frontend/src/pages/public/FacultyPortalPage.tsx
...
- frontend/src/pages/public/ResearchPage.tsx
- frontend/src/pages/public/SemanticLanding.tsx
- frontend/src/pages/public/ServicesPage.tsx
- frontend/src/pages/public/StudentLookup.tsx
- frontend/src/pages/public/StudentPortalPage.tsx
...
- frontend/src/pages/public/student-registration-ocr.ts
- frontend/src/pages/student/StudentDashboard.tsx
- frontend/src/pages/student/desktop/AttendancePage.tsx
- frontend/src/pages/student/desktop/Certificates.tsx
- frontend/src/pages/student/desktop/Documents.tsx
- frontend/src/pages/student/desktop/PersonalInfo.tsx
- frontend/src/pages/student/desktop/RegisterClass.tsx
- frontend/src/pages/student/desktop/StudentFeedbackView.tsx
- frontend/src/pages/student/desktop/StudentMessaging.tsx
- frontend/src/pages/student/desktop/StudentMyClassesView.tsx
- frontend/src/pages/student/mobile/MobileCertificatesModule.tsx
- frontend/src/pages/student/mobile/MobileDocumentsModule.tsx
- frontend/src/pages/student/mobile/MobileMessagesModule.tsx
- frontend/src/pages/student/mobile/MobileProfileModule.tsx
- frontend/src/pages/student/mobile/StudentDashboardMobile.tsx
- frontend/src/services/api-admin-methods.ts
- frontend/src/services/api-attendance-methods.ts
- frontend/src/services/api-certificate-methods.ts
- frontend/src/services/api-class-methods.ts
- frontend/src/services/api-class-schedule-methods.ts
- frontend/src/services/api-client-core.ts
- frontend/src/services/api-document-methods.ts
- frontend/src/services/api-document-upload-helper.ts
- frontend/src/services/api-exam-schedule-methods.ts
- frontend/src/services/api-export-methods.ts
- frontend/src/services/api-feedback-methods.ts
- frontend/src/services/api-messaging-methods.ts
- frontend/src/services/api-misc-methods.ts
- frontend/src/services/api-payment-methods.ts
- frontend/src/services/api-post-methods.ts
- frontend/src/services/api-registration-methods.ts
- frontend/src/services/api-request-engine.ts
- frontend/src/services/api-review-methods.ts
- frontend/src/services/api-student-methods.ts
- frontend/src/services/api-teacher-methods.ts
...
- frontend/src/styles/public/UnifiedLogin.css
- frontend/src/utils/analytics-init.ts
- frontend/src/utils/analytics-track.ts
- frontend/src/utils/birthPlaceOptions.ts
- frontend/src/utils/cache.ts
- frontend/src/utils/dateUtils.ts
- frontend/src/utils/documentDetection.ts
- frontend/src/utils/error-tracker-setup.ts
...
- frontend/src/utils/realtimeQuality.ts
- frontend/src/utils/scoreCalculator.ts
- frontend/src/utils/statusUtils.ts
- frontend/src/utils/studentDataLoader.ts
- frontend/src/utils/studentProfilePolicy.ts
- frontend/src/utils/translations.ts
- frontend/src/workers/documentDetectionWorker.ts
- frontend/test/pages/student-registration-ocr.test.ts
