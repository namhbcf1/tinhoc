...
import { assignTeacherToClass, removeTeacherAssignmentById, getClassTeachers, } from '../db/class-teacher-queries.js';
import { findAdminById } from '../db/admin-queries.js';
import { requireAdmin } from '../middleware/auth-middleware.js';
const classTeachers = new Hono();
// ========================================
...
classTeachers.post('/', adminAuthMiddleware, async (c) => {
    try {
        ...
        const admin = await findAdminById(c.env.DB, parseInt(admin_id));
        if (!admin) {
