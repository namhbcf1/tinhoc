export async function getCurrentAttempt(db: D1Database, studentId: string | number, testId: string | number) {
...
export async function getExamAttempt(db: D1Database, attemptId: string | number) {
...
export async function getMyAttempts(db: D1Database, studentId: string | number, filters: { status?: string } = {}) {
  let query = `
    SELECT
...
export async function updateExamAttempt(db: D1Database, attemptId: string | number, data: {
...
export async function checkRegistrationStatus(db: D1Database, studentId: string | number, testId: string | number) {
  const result = await db.prepare(`
