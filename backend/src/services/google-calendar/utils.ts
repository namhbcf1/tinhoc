 ...
 * @param scheduleRule - e.g. "WEEKLY:1,3,5"
 * @param endDate - e.g. "2026-12-31"
 */
export function buildRRule(scheduleRule: string | null | undefined, endDate?: string | null): string | null {
 ...
 * @param scheduleTime - e.g. "19:00-21:00"
 * @param startDate - e.g. "2026-01-22"
 * @param timezone - e.g. "Asia/Ho_Chi_Minh"
 */
export function parseScheduleTime(scheduleTime: string, startDate: string, timezone: string): {
 ...
 */
export function getNextDateForDayOfWeek(fromDate: Date | string, targetDayOfWeek: number): string {
