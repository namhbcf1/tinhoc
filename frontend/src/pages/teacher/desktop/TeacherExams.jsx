...
export default function TeacherExams({ teacher }) {
  ...
  const loadExams = async () => {
    ...
    try {
      ...
      const response = await api.cachedRequest('/teachers/my-exams', { tokenType: 'teacher' }, true);
      if (response.success) {
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2">
                          ...
                          <div className="flex items-center gap-2 text-slate-600">
                            ...
                            <span className="text-sm font-medium">{formatTime(exam.exam_date)} ({exam.duration_minutes} phút)</span>
                          </div>
                          {exam.location && (
                            <div className="flex items-center gap-2 text-slate-600">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-slate-700 text-sm">{formatTime(selectedExam.exam_date)} ({selectedExam.duration_minutes} phút)</p>
                  </div>
                </div>
