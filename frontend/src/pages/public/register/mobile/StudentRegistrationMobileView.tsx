...
import StudentRegistrationMobileUploadSection from './StudentRegistrationMobileUploadSection';
import StudentRegistrationMobileFormFields from './StudentRegistrationMobileFormFields';
import StudentRegistrationMobileFooterSection from './StudentRegistrationMobileFooterSection';


export default function StudentRegistrationMobileView({
      ...
      <div className="a4-form-wrapper vt-registration-paper">
        ...
        <form noValidate onFocusCapture={handleFormFocusCapture} onSubmit={handleSubmit(onSubmit, handleInvalidSubmit)}>
          ...
          <div className="a4-section vt-registration-section">
            ...
            <StudentRegistrationMobileUploadSection
            ...
            <StudentRegistrationMobileFormFields
              register={register}
              errors={errors}
...
{/* ===== CAM KẾT ===== */}
           <StudentRegistrationMobileFooterSection
            register={register}
            errors={errors}
            fieldErrorId={fieldErrorId}
            errorMsg={errorMsg}
