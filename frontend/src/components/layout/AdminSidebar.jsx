...
import {
    LayoutDashboard, Users, CreditCard, Award, Newspaper,
    Home, Folder, BarChart3, GraduationCap, CalendarDays,
    Shield, Database, UserCircle, History, LogOut, X, Video,
...
const menuGroups = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'admins', label: 'Quản lý Admin', icon: Shield, superAdminOnly: true },
            { id: 'backup', label: 'Sao lưu', icon: Database, superAdminOnly: true },
                ...
                <div className="flex items-center justify-between h-[76px] px-6 border-b border-slate-100 shrink-0 bg-white/50 backdrop-blur-md">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <span className="text-[11px] font-bold text-slate-400 tracking-wide uppercase mt-0.5">VanTrang Edu</span>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
